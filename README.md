...
1. **봇 토큰** 입력
2. **채팅 ID** 입력 (마이너스 포함, 예: `-1001234567890`)
3. **저장** 탭
...
`ConfigManager.kt`에서 대상 앱과 발신자를 수정할 수 있습니다.
...
// 포워딩할 발신자명 (알림 title과 매칭)
val allowedSenders = setOf(
    "삼성카드",
    "신한카드",
    "현대카드",
    "하나카드",
...
연락처에 미등록된 번호로 수신되는 경우 전화번호를 직접 추가할 수 있습니다:
